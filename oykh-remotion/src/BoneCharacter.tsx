...
export const BoneCharacter: React.FC<BoneCharacterProps> = ({
  pose,
  x = 960,
  y = 540,
  scale = 1,
...
// Animated version
interface AnimatedBoneCharacterProps {
...
export const AnimatedBoneCharacter: React.FC<AnimatedBoneCharacterProps> = ({
  poseSequence,
  x = 960,
  y = 540,
  scale = 1,
  ...
  return <BoneCharacter pose={currentPose} x={x} y={y + bob} scale={scale}/>;
};
